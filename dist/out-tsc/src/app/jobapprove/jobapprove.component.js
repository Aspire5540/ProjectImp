...
let JobapproveComponent = class JobapproveComponent {
    constructor(configService) {
        ...
        this.selected = 2;
        this.nWbs = 0;
        this.displayedColumns = ['wbs', 'jobName', 'mv', 'lv', 'tr', 'causeName', 'solveMet', 'note', 'workCostPln', 'del'];
...
], JobapproveComponent.prototype, "registerForm", void 0);
tslib_1.__decorate([
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", MatPaginator)
], JobapproveComponent.prototype, "paginator1", void 0);
tslib_1.__decorate([
    ViewChild('sort1', { static: false }),
    tslib_1.__metadata("design:type", MatSort)
], JobapproveComponent.prototype, "sort1", void 0);
JobapproveComponent = tslib_1.__decorate([
    Component({
