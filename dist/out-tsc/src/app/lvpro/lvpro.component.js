...
let LVProComponent = class LVProComponent {
    constructor(configService, authService, http, uploadService) {
        this.configService = configService;
        this.authService = authService;
        this.http = http;
        this.uploadService = uploadService;
        this.displayedColumns = ['PEA_TR', 'Location', 'PLoadTOT', 'minV', 'WBS', 'Status', 'RLoad', 'RVoltage', 'PEA_Meter'];
        this.displayedColumns1 = ['Feeder', 'PEA_Meter', 'CustName', 'SUBTYPECOD', 'kWh', 'rate', 'rateMeter', 'Voltage', 'Line_Type'];
        this.displayedColumns2 = ['PEA_TR', 'Feeder', 'PEA_Meter', 'CustName', 'SUBTYPECOD', 'kWh', 'rate', 'rateMeter', 'Voltage', 'Line_Type'];
        this.condition = 0;
        this.peaCode = "";
        this.meterdata = [];
        this.Statuss = [
...
], LVProComponent.prototype, "registerForm", void 0);
tslib_1.__decorate([
    ViewChild(MatPaginator, { static: true }),
    tslib_1.__metadata("design:type", MatPaginator)
], LVProComponent.prototype, "paginator", void 0);
tslib_1.__decorate([
    ViewChild(MatSort, { static: true }),
    tslib_1.__metadata("design:type", MatSort)
], LVProComponent.prototype, "sort", void 0);
tslib_1.__decorate([
    ViewChild('paginator1', { static: true }),
    tslib_1.__metadata("design:type", MatPaginator)
], LVProComponent.prototype, "paginator1", void 0);
tslib_1.__decorate([
    ViewChild('sort1', { static: true }),
    tslib_1.__metadata("design:type", MatSort)
], LVProComponent.prototype, "sort1", void 0);
tslib_1.__decorate([
    ViewChild('paginator2', { static: true }),
    tslib_1.__metadata("design:type", MatPaginator)
], LVProComponent.prototype, "paginator2", void 0);
tslib_1.__decorate([
    ViewChild('sort2', { static: true }),
    tslib_1.__metadata("design:type", MatSort)
], LVProComponent.prototype, "sort2", void 0);
LVProComponent = tslib_1.__decorate([
    Component({
        selector: 'app-lvpro',
...
export { LVProComponent };
//# sourceMappingURL=lvpro.component.js.map