...
let RoicComponent = class RoicComponent {
    constructor(configService) {
        ...
        this.kvaTotal = 0;
        this.kvaD1Total = 0;
        this.graphChoice = 'kva';
        this.displayedColumns = ['wbs', 'jobName', 'workCostPln', 'workCostAct', 'percent', 'jobStatus', 'userStatus'];
        this.displayedColumns2 = ['wbs', 'jobName', 'workCostPln', 'workCostAct', 'percent', 'jobStatus', 'userStatus'];
...
], RoicComponent.prototype, "paginator", void 0);
tslib_1.__decorate([
    ViewChild('paginator2', { static: false }),
    tslib_1.__metadata("design:type", MatPaginator)
], RoicComponent.prototype, "paginator2", void 0);
tslib_1.__decorate([
    ViewChild('sort', { static: true }),
    tslib_1.__metadata("design:type", MatSort)
], RoicComponent.prototype, "sort", void 0);
tslib_1.__decorate([
    ViewChild('sort2', { static: false }),
    tslib_1.__metadata("design:type", MatSort)
], RoicComponent.prototype, "sort2", void 0);
RoicComponent = tslib_1.__decorate([
    Component({
        selector: 'app-roic',
...
export { RoicComponent };
//# sourceMappingURL=roic.component.js.map